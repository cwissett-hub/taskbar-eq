...
pub fn family_for(id: &str) -> Box<dyn Family> {
    ...
    match id {
        ...
        "pipes" => Box::new(pipes::Pipes::default()),
        "orbit" => Box::new(orbit::Orbit::default()),
        "blossom" => Box::new(blossom::Blossom::default()),
